...
- [Linux Fundamental](#linux-fundamental)
  ...
  - [Buscando comandos com Ctrl + r](#buscando-comandos-com-ctrl--r)
- [Gerenciamento de diretórios e arquivos](#gerenciamento-de-diretórios-e-arquivos)
  - [Criando diretórios mkdir](#criando-diretórios-mkdir)
  - [Removendo arquivos e diretórios rm](#removendo-arquivos-e-diretórios-rm)
  - [Removendo apenas diretórios rmdir](#removendo-apenas-diretórios-rmdir)
  - [Copiando diretórios e arquivos cp](#copiando-diretórios-e-arquivos-cp)
  - [Movendo diretórios e arquivos mv](#movendo-diretórios-e-arquivos-mv)
  - [pwd](#pwd)
- [Gerenciamento de pacotes e aplicativos](#gerenciamento-de-pacotes-e-aplicativos)
  - [Atualizando repositórios](#atualizando-repositórios)
  - [Instalando pacotes / aplicativos](#instalando-pacotes--aplicativos)
  - [Deletando um pacote/ aplicativo](#deletando-um-pacote-aplicativo)
  - [Atualizando o Linux](#atualizando-o-linux)
  - [Limpando pacotes / aplicativos desnecessários](#limpando-pacotes--aplicativos-desnecessários)
  - [Buscando pacotes / aplicativos](#buscando-pacotes--aplicativos)
  - [Utilizando apenas apt](#utilizando-apenas-apt)
  - [Salvando o estado da máquina (VM)](#salvando-o-estado-da-máquina-vm)
- [Filtros e buscas de arquivos e diretórios](#filtros-e-buscas-de-arquivos-e-diretórios)
  - [Comando head](#comando-head)
  - [Comando Tail](#comando-tail)
  - [Comando Grep](#comando-grep)
  - [Comando find](#comando-find)
  - [Comando locate](#comando-locate)
  - [Onde os comandos são executados](#onde-os-comandos-são-executados)
- [Editores de texto](#editores-de-texto)
  - [Nano: criando, salvando e saindo de arquivo](#nano-criando-salvando-e-saindo-de-arquivo)
  - [Nano: editando arquivo](#nano-editando-arquivo)
  - [Nano: copiando, colando e recortando conteúdo](#nano-copiando-colando-e-recortando-conteúdo)
  - [Nano: movimentação dentro de arquivo](#nano-movimentação-dentro-de-arquivo)
  - [Nano: busca e replace](#nano-busca-e-replace)
  - [Vim: instalação e modos do editor](#vim-instalação-e-modos-do-editor)
  - [Vim: editando, salvando e fechando arquivo](#vim-editando-salvando-e-fechando-arquivo)
  - [Vim: deletando linha, undo e redo](#vim-deletando-linha-undo-e-redo)
  - [Vim: search e replace](#vim-search-e-replace)
  - [Dica: Saindo sem salvar arquivo no Vim](#dica-saindo-sem-salvar-arquivo-no-vim)
- [Gerenciamento de usuários e grupos](#gerenciamento-de-usuários-e-grupos)
  - [Adicionando usuários ao linux](#adicionando-usuários-ao-linux)
  - [Deletando usuários](#deletando-usuários)
  - [Mudando o nome de display do usuário](#mudando-o-nome-de-display-do-usuário)
  - [Mudando o nome do diretório base e do usuário no terminal](#mudando-o-nome-do-diretório-base-e-do-usuário-no-terminal)
  - [Bloqueando e desbloqueando usuários](#bloqueando-e-desbloqueando-usuários)
  - [O que é um grupo no linux](#o-que-é-um-grupo-no-linux)
  - [Criando um grupo no Linux](#criando-um-grupo-no-linux)
  - [Deletando um grupo](#deletando-um-grupo)
  - [Movendo um usuário para outro grupo](#movendo-um-usuário-para-outro-grupo)
  - [Dica: como virar um super usuário (root);](#dica-como-virar-um-super-usuário-root)
  - [Dica: trocando a senha do usuário](#dica-trocando-a-senha-do-usuário)
- [Gerenciamento de Permissões](#gerenciamento-de-permissões)
  - [Conceitos fundamentais de permissão](#conceitos-fundamentais-de-permissão)
  - [Entendendo como funcionam as permissões](#entendendo-como-funcionam-as-permissões)
  - [Permissão numérica: teoria](#permissão-numérica-teoria)
  - [Permissão numérica: prática](#permissão-numérica-prática)
  - [Permissão simbólica: teoria](#permissão-simbólica-teoria)
  - [Permissão simbólica: prática](#permissão-simbólica-prática)
  - [Alterando o proprietário / owner do arquivo](#alterando-o-proprietário--owner-do-arquivo)
  - [Alterando o grupo do arquivo](#alterando-o-grupo-do-arquivo)
  - [Dica: copiando e colando no terminal](#dica-copiando-e-colando-no-terminal)
  - [Dica: histórico de últimos comandos digitados](#dica-histórico-de-últimos-comandos-digitados)
- [Gerenciamento básico de redes](#gerenciamento-básico-de-redes)
  - [Como a web funciona?](#como-a-web-funciona)
  - [O que é DNS?](#o-que-é-dns)
  - [Funcionamento:](#funcionamento)
  - [O que são portas?](#o-que-são-portas)
  - [O que é TCP?](#o-que-é-tcp)
  - [O que utiliza o TCP:](#o-que-utiliza-o-tcp)
  - [O que é UDP?](#o-que-é-udp)
  - [Comando: ping](#comando-ping)
  - [Comando: netstat](#comando-netstat)
  - [Comando ifconfig ( interface configuration )](#comando-ifconfig--interface-configuration-)
  - [Comando nslookup](#comando-nslookup)
  - [Comando tcpdump](#comando-tcpdump)
  - [Dica: como ver o ip da sua máquina](#dica-como-ver-o-ip-da-sua-máquina)
- [Compactação e descompactação de arquivos e diretórios](#compactação-e-descompactação-de-arquivos-e-diretórios)
  - [Compactando arquivos com tar](#compactando-arquivos-com-tar)
  - [Compactando múltiplos arquivos em um só](#compactando-múltiplos-arquivos-em-um-só)
  - [Descompactando arquivos](#descompactando-arquivos)
  - [Compactação em zip](#compactação-em-zip)
  - [Descompactando arquivos em zip](#descompactando-arquivos-em-zip)
  - [Dica: veja o que tem dentro dos arquivos compactados](#dica-veja-o-que-tem-dentro-dos-arquivos-compactados)
